...
async def tags(ctx, *, tag_args):
    try:
        ...
        embed.add_field(name="Character Tags:", value=json_data[i]["tag_string_character"], inline=False)
        embed.add_field(name="Game/Anime/Franchise:", value=json_data[i]["tag_string_copyright"], inline=False)
